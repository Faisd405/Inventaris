...
export default {
  ...
  created() {
    this.axios.get(`/api/barang`).then((response) => {
      this.barang = response.data.barang;
    });
    this.axios.get(`/api/barang/NoUser`).then((response) => {
      this.NoUser = response.data.barang;
    });
    this.axios.get(`/api/buku`).then((response) => {
      this.buku = response.data.buku;
    });
    this.axios.get(`/api/users`).then((response) => {
      this.user = response.data.user;
    });
    this.axios.get(`/api/kategori`).then((response) => {
